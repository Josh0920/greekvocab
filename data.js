...
const CHAPTER_MAP = {
    ...
    "θλῖψις, -εως, ἡ": 25, "σωτηρία, -ας, ἡ": 25,
    // Chapter 27
    ...
    "ἀνοίγω": 27, "ἀπαγγέλλω": 27, "διακονέω": 27, "διακονία, -ας, ἡ": 27,
    "ἱλαστήριον, -ου, τό": 27, "φανερόω": 27,
    // Chapter 28
