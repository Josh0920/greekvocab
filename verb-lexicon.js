const VERB_LEXICON = {
  "εἰμί": {
    ...
    indicative: {
      ...
      "Imperfect Active Indicative": ["ἦν / ἤμην", "ἦς", "ἦν", "ἦμεν / ἤμεθα", "ἦτε", "ἦσαν"],
    },
    subjunctive: {
  ...
  "λύω": {
    ...
    indicative: {
      "Present Active Indicative": ["λύω", "λύεις", "λύει", "λύομεν", "λύετε", "λύουσιν"],
      "Present Middle/Passive Indicative": ["λύομαι", "λύῃ", "λύεται", "λυόμεθα", "λύεσθε", "λύονται"],
      "Future Active Indicative": ["λύσω", "λύσεις", "λύσει", "λύσομεν", "λύσετε", "λύσουσιν"],
      ...
      "Perfect Active Indicative": ["λέλυκα", "λέλυκας", "λέλυκε(ν)", "λελύκαμεν", "λελύκατε", "λελύκασιν"],
  ...
  "λέγω": {
    meaning: "I say, speak",
    indicative: {
      "Present Active Indicative": ["λέγω", "λέγεις", "λέγει", "λέγομεν", "λέγετε", "λέγουσιν"],
      "Present Middle/Passive Indicative": ["λέγομαι", "λέγῃ", "λέγεται", "λεγόμεθα", "λέγεσθε", "λέγονται"],
      "Future Active Indicative": ["ἐρῶ", "ἐρεῖς", "ἐρεῖ", "ἐροῦμεν", "ἐρεῖτε", "ἐροῦσιν"],
      ...
      "Perfect Active Indicative": ["εἴρηκα", "εἴρηκας", "εἴρηκε(ν)", "εἰρήκαμεν", "εἰρήκατε", "εἰρήκασιν"],
  ...
  "ἀκούω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἀκούω", "ἀκούεις", "ἀκούει", "ἀκούομεν", "ἀκούετε", "ἀκούουσιν"],
      "Present Middle/Passive Indicative": ["ἀκούομαι", "ἀκούῃ", "ἀκούεται", "ἀκουόμεθα", "ἀκούεσθε", "ἀκούονται"],
      "Future Active Indicative": ["ἀκούσω", "ἀκούσεις", "ἀκούσει", "ἀκούσομεν", "ἀκούσετε", "ἀκούσουσιν"],
      ...
      "Perfect Active Indicative": ["ἀκήκοα", "ἀκήκοας", "ἀκήκοε(ν)", "ἀκηκόαμεν", "ἀκηκόατε", "ἀκηκόασιν"],
    },
    subjunctive: {
  ...
  "βλέπω": {
    ...
    indicative: {
      "Present Active Indicative": ["βλέπω", "βλέπεις", "βλέπει", "βλέπομεν", "βλέπετε", "βλέπουσιν"],
      "Present Middle/Passive Indicative": ["βλέπομαι", "βλέπῃ", "βλέπεται", "βλεπόμεθα", "βλέπεσθε", "βλέπονται"],
      "Future Active Indicative": ["βλέψω", "βλέψεις", "βλέψει", "βλέψομεν", "βλέψετε", "βλέψουσιν"],
  ...
  "ἔχω": {
    meaning: "I have, hold",
    indicative: {
      "Present Active Indicative": ["ἔχω", "ἔχεις", "ἔχει", "ἔχομεν", "ἔχετε", "ἔχουσιν"],
      "Present Middle/Passive Indicative": ["ἔχομαι", "ἔχῃ", "ἔχεται", "ἐχόμεθα", "ἔχεσθε", "ἔχονται"],
      "Future Active Indicative": ["ἕξω", "ἕξεις", "ἕξει", "ἕξομεν", "ἕξετε", "ἕξουσιν"],
      "Imperfect Active Indicative": ["εἶχον", "εἶχες", "εἶχε(ν)", "εἴχομεν", "εἴχετε", "εἶχον"],
      "Perfect Active Indicative": ["ἔσχηκα", "ἔσχηκας", "ἔσχηκε(ν)", "ἐσχήκαμεν", "ἐσχήκατε", "ἐσχήκασιν"],
  ...
  "πιστεύω": {
    ...
    indicative: {
      "Present Active Indicative": ["πιστεύω", "πιστεύεις", "πιστεύει", "πιστεύομεν", "πιστεύετε", "πιστεύουσιν"],
      "Present Middle/Passive Indicative": ["πιστεύομαι", "πιστεύῃ", "πιστεύεται", "πιστευόμεθα", "πιστεύεσθε", "πιστεύονται"],
      "Future Active Indicative": ["πιστεύσω", "πιστεύσεις", "πιστεύσει", "πιστεύσομεν", "πιστεύσετε", "πιστεύσουσιν"],
      ...
      "Perfect Active Indicative": ["πεπίστευκα", "πεπίστευκας", "πεπίστευκε(ν)", "πεπιστεύκαμεν", "πεπιστεύκατε", "πεπιστεύκασιν"],
  ...
  "ἀγαπάω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἀγαπῶ", "ἀγαπᾷς", "ἀγαπᾷ", "ἀγαπῶμεν", "ἀγαπᾶτε", "ἀγαπῶσιν"],
      "Present Middle/Passive Indicative": ["ἀγαπῶμαι", "ἀγαπᾷ", "ἀγαπᾶται", "ἀγαπώμεθα", "ἀγαπᾶσθε", "ἀγαπῶνται"],
      "Future Active Indicative": ["ἀγαπήσω", "ἀγαπήσεις", "ἀγαπήσει", "ἀγαπήσομεν", "ἀγαπήσετε", "ἀγαπήσουσιν"],
      ...
      "Perfect Active Indicative": ["ἠγάπηκα", "ἠγάπηκας", "ἠγάπηκε(ν)", "ἠγαπήκαμεν", "ἠγαπήκατε", "ἠγαπήκασιν"],
  ...
  "ζητέω": {
    ...
    indicative: {
      "Present Active Indicative": ["ζητῶ", "ζητεῖς", "ζητεῖ", "ζητοῦμεν", "ζητεῖτε", "ζητοῦσιν"],
      "Present Middle/Passive Indicative": ["ζητοῦμαι", "ζητῇ", "ζητεῖται", "ζητούμεθα", "ζητεῖσθε", "ζητοῦνται"],
      "Future Active Indicative": ["ζητήσω", "ζητήσεις", "ζητήσει", "ζητήσομεν", "ζητήσετε", "ζητήσουσιν"],
      ...
      "Perfect Active Indicative": ["ἐζήτηκα", "ἐζήτηκας", "ἐζήτηκε(ν)", "ἐζητήκαμεν", "ἐζητήκατε", "ἐζητήκασιν"],
    },
    subjunctive: {
  ...
  "καλέω": {
    ...
    indicative: {
      "Present Active Indicative": ["καλῶ", "καλεῖς", "καλεῖ", "καλοῦμεν", "καλεῖτε", "καλοῦσιν"],
      "Present Middle/Passive Indicative": ["καλοῦμαι", "καλῇ", "καλεῖται", "καλούμεθα", "καλεῖσθε", "καλοῦνται"],
      "Future Active Indicative": ["καλέσω", "καλέσεις", "καλέσει", "καλέσομεν", "καλέσετε", "καλέσουσιν"],
      ...
      "Perfect Active Indicative": ["κέκληκα", "κέκληκας", "κέκληκε(ν)", "κεκλήκαμεν", "κεκλήκατε", "κεκλήκασιν"],
  ...
  "λαλέω": {
    meaning: "I speak, say",
    indicative: {
      "Present Active Indicative": ["λαλῶ", "λαλεῖς", "λαλεῖ", "λαλοῦμεν", "λαλεῖτε", "λαλοῦσιν"],
      "Present Middle/Passive Indicative": ["λαλοῦμαι", "λαλῇ", "λαλεῖται", "λαλούμεθα", "λαλεῖσθε", "λαλοῦνται"],
      "Future Active Indicative": ["λαλήσω", "λαλήσεις", "λαλήσει", "λαλήσομεν", "λαλήσετε", "λαλήσουσιν"],
      ...
      "Perfect Active Indicative": ["λελάληκα", "λελάληκας", "λελάληκε(ν)", "λελαλήκαμεν", "λελαλήκατε", "λελαλήκασιν"],
  ...
  "πληρόω": {
    ...
    indicative: {
      "Present Active Indicative": ["πληρῶ", "πληροῖς", "πληροῖ", "πληροῦμεν", "πληροῦτε", "πληροῦσιν"],
      "Present Middle/Passive Indicative": ["πληροῦμαι", "πληροῖ", "πληροῦται", "πληρούμεθα", "πληροῦσθε", "πληροῦνται"],
      "Future Active Indicative": ["πληρώσω", "πληρώσεις", "πληρώσει", "πληρώσομεν", "πληρώσετε", "πληρώσουσιν"],
      "Imperfect Active Indicative": ["ἐπλήρουν", "ἐπλήρους", "ἐπλήρου", "ἐπληροῦμεν", "ἐπληροῦτε", "ἐπλήρουν"],
      ...
      "Perfect Active Indicative": ["πεπλήρωκα", "πεπλήρωκας", "πεπλήρωκε(ν)", "πεπληρώκαμεν", "πεπληρώκατε", "πεπληρώκασιν"],
  ...
  "ποιέω": {
    meaning: "I do, make",
    indicative: {
      "Present Active Indicative": ["ποιῶ", "ποιεῖς", "ποιεῖ", "ποιοῦμεν", "ποιεῖτε", "ποιοῦσιν"],
      "Present Middle/Passive Indicative": ["ποιοῦμαι", "ποιῇ", "ποιεῖται", "ποιούμεθα", "ποιεῖσθε", "ποιοῦνται"],
      "Future Active Indicative": ["ποιήσω", "ποιήσεις", "ποιήσει", "ποιήσομεν", "ποιήσετε", "ποιήσουσιν"],
      ...
      "1st Aorist Middle Indicative": ["ἐποιησάμην", "ἐποιήσω", "ἐποιήσατο", "ἐποιησάμεθα", "ἐποιήσασθε", "ἐποιήσαντο"],
      "Perfect Active Indicative": ["πεποίηκα", "πεποίηκας", "πεποίηκε(ν)", "πεποιήκαμεν", "πεποιήκατε", "πεποιήκασιν"],
  ...
  "τηρέω": {
    ...
    indicative: {
      "Present Active Indicative": ["τηρῶ", "τηρεῖς", "τηρεῖ", "τηροῦμεν", "τηρεῖτε", "τηροῦσιν"],
      "Present Middle/Passive Indicative": ["τηροῦμαι", "τηρῇ", "τηρεῖται", "τηρούμεθα", "τηρεῖσθε", "τηροῦνται"],
      "Future Active Indicative": ["τηρήσω", "τηρήσεις", "τηρήσει", "τηρήσομεν", "τηρήσετε", "τηρήσουσιν"],
      ...
      "Perfect Active Indicative": ["τετήρηκα", "τετήρηκας", "τετήρηκε(ν)", "τετηρήκαμεν", "τετηρήκατε", "τετηρήκασιν"],
  ...
  "γεννάω": {
    ...
    indicative: {
      "Present Active Indicative": ["γεννῶ", "γεννᾷς", "γεννᾷ", "γεννῶμεν", "γεννᾶτε", "γεννῶσιν"],
      "Present Middle/Passive Indicative": ["γεννῶμαι", "γεννᾷ", "γεννᾶται", "γεννώμεθα", "γεννᾶσθε", "γεννῶνται"],
      "Future Active Indicative": ["γεννήσω", "γεννήσεις", "γεννήσει", "γεννήσομεν", "γεννήσετε", "γεννήσουσιν"],
      ...
      "Perfect Active Indicative": ["γεγέννηκα", "γεγέννηκας", "γεγέννηκε(ν)", "γεγεννήκαμεν", "γεγεννήκατε", "γεγεννήκασιν"],
  ...
  "ζάω": {
    meaning: "I live",
    indicative: {
      "Present Active Indicative": ["ζῶ", "ζῇς", "ζῇ", "ζῶμεν", "ζῆτε", "ζῶσιν"],
      "Future Active Indicative": ["ζήσω", "ζήσεις", "ζήσει", "ζήσομεν", "ζήσετε", "ζήσουσιν"],
      "Imperfect Active Indicative": ["ἔζων", "ἔζης", "ἔζη", "ἐζῶμεν", "ἐζῆτε", "ἔζων"],
  ...
  "αἴρω": {
    ...
    indicative: {
      "Present Active Indicative": ["αἴρω", "αἴρεις", "αἴρει", "αἴρομεν", "αἴρετε", "αἴρουσιν"],
      "Present Middle/Passive Indicative": ["αἴρομαι", "αἴρῃ", "αἴρεται", "αἰρόμεθα", "αἴρεσθε", "αἴρονται"],
      "Future Active Indicative": ["ἀρῶ", "ἀρεῖς", "ἀρεῖ", "ἀροῦμεν", "ἀρεῖτε", "ἀροῦσιν"],
      "Imperfect Active Indicative": ["ἦρον", "ἦρες", "ἦρε(ν)", "ἤρομεν", "ἤρετε", "ἦρον"],
      ...
      "Perfect Active Indicative": ["ἦρκα", "ἦρκας", "ἦρκε(ν)", "ἤρκαμεν", "ἤρκατε", "ἤρκασιν"],
  ...
  "ἀποκτείνω": {
    meaning: "I kill",
    indicative: {
      "Present Active Indicative": ["ἀποκτείνω", "ἀποκτείνεις", "ἀποκτείνει", "ἀποκτείνομεν", "ἀποκτείνετε", "ἀποκτείνουσιν"],
      "Future Active Indicative": ["ἀποκτενῶ", "ἀποκτενεῖς", "ἀποκτενεῖ", "ἀποκτενοῦμεν", "ἀποκτενεῖτε", "ἀποκτενοῦσιν"],
  ...
  "ἀποστέλλω": {
    meaning: "I send (away)",
    indicative: {
      "Present Active Indicative": ["ἀποστέλλω", "ἀποστέλλεις", "ἀποστέλλει", "ἀποστέλλομεν", "ἀποστέλλετε", "ἀποστέλλουσιν"],
      "Present Middle/Passive Indicative": ["ἀποστέλλομαι", "ἀποστέλλῃ", "ἀποστέλλεται", "ἀποστελλόμεθα", "ἀποστέλλεσθε", "ἀποστέλλονται"],
      "Future Active Indicative": ["ἀποστελῶ", "ἀποστελεῖς", "ἀποστελεῖ", "ἀποστελοῦμεν", "ἀποστελεῖτε", "ἀποστελοῦσιν"],
      ...
      "Perfect Active Indicative": ["ἀπέσταλκα", "ἀπέσταλκας", "ἀπέσταλκε(ν)", "ἀπεστάλκαμεν", "ἀπεστάλκατε", "ἀπεστάλκασιν"],
  ...
  "βαπτίζω": {
    ...
    indicative: {
      "Present Active Indicative": ["βαπτίζω", "βαπτίζεις", "βαπτίζει", "βαπτίζομεν", "βαπτίζετε", "βαπτίζουσιν"],
      "Present Middle/Passive Indicative": ["βαπτίζομαι", "βαπτίζῃ", "βαπτίζεται", "βαπτιζόμεθα", "βαπτίζεσθε", "βαπτίζονται"],
      "Future Active Indicative": ["βαπτίσω", "βαπτίσεις", "βαπτίσει", "βαπτίσομεν", "βαπτίσετε", "βαπτίσουσιν"],
      ...
      "Perfect Active Indicative": ["βεβάπτικα", "βεβάπτικας", "βεβάπτικε(ν)", "βεβαπτίκαμεν", "βεβαπτίκατε", "βεβαπτίκασιν"],
  ...
  "γινώσκω": {
    ...
    indicative: {
      "Present Active Indicative": ["γινώσκω", "γινώσκεις", "γινώσκει", "γινώσκομεν", "γινώσκετε", "γινώσκουσιν"],
  ...
  "ἐγείρω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἐγείρω", "ἐγείρεις", "ἐγείρει", "ἐγείρομεν", "ἐγείρετε", "ἐγείρουσιν"],
      "Present Middle/Passive Indicative": ["ἐγείρομαι", "ἐγείρῃ", "ἐγείρεται", "ἐγειρόμεθα", "ἐγείρεσθε", "ἐγείρονται"],
      "Future Active Indicative": ["ἐγερῶ", "ἐγερεῖς", "ἐγερεῖ", "ἐγεροῦμεν", "ἐγερεῖτε", "ἐγεροῦσιν"],
  ...
  "ἐκβάλλω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἐκβάλλω", "ἐκβάλλεις", "ἐκβάλλει", "ἐκβάλλομεν", "ἐκβάλλετε", "ἐκβάλλουσιν"],
      "Future Active Indicative": ["ἐκβαλῶ", "ἐκβαλεῖς", "ἐκβαλεῖ", "ἐκβαλοῦμεν", "ἐκβαλεῖτε", "ἐκβαλοῦσιν"],
      "Imperfect Active Indicative": ["ἐξέβαλλον", "ἐξέβαλλες", "ἐξέβαλλε(ν)", "ἐξεβάλλομεν", "ἐξεβάλλετε", "ἐξέβαλλον"],
      "Perfect Active Indicative": ["ἐκβέβληκα", "ἐκβέβληκας", "ἐκβέβληκε(ν)", "ἐκβεβλήκαμεν", "ἐκβεβλήκατε", "ἐκβεβλήκασιν"],
  ...
  "κρίνω": {
    ...
    indicative: {
      "Present Active Indicative": ["κρίνω", "κρίνεις", "κρίνει", "κρίνομεν", "κρίνετε", "κρίνουσιν"],
      "Present Middle/Passive Indicative": ["κρίνομαι", "κρίνῃ", "κρίνεται", "κρινόμεθα", "κρίνεσθε", "κρίνονται"],
      "Future Active Indicative": ["κρινῶ", "κρινεῖς", "κρινεῖ", "κρινοῦμεν", "κρινεῖτε", "κρινοῦσιν"],
      "Future Middle Indicative": ["κρινοῦμαι", "κρινῇ", "κρινεῖται", "κρινούμεθα", "κρινεῖσθε", "κρινοῦνται"],
      "Imperfect Active Indicative": ["ἔκρινον", "ἔκρινες", "ἔκρινε(ν)", "ἐκρίνομεν", "ἐκρίνετε", "ἔκρινον"],
      ...
      "Perfect Active Indicative": ["κέκρικα", "κέκρικας", "κέκρικε(ν)", "κεκρίκαμεν", "κεκρίκατε", "κεκρίκασιν"],
  ...
  "μένω": {
    ...
    indicative: {
      "Present Active Indicative": ["μένω", "μένεις", "μένει", "μένομεν", "μένετε", "μένουσιν"],
      "Present Middle/Passive Indicative": ["μένομαι", "μένῃ", "μένεται", "μενόμεθα", "μένεσθε", "μένονται"],
      "Future Active Indicative": ["μενῶ", "μενεῖς", "μενεῖ", "μενοῦμεν", "μενεῖτε", "μενοῦσιν"],
      "Imperfect Active Indicative": ["ἔμενον", "ἔμενες", "ἔμενε(ν)", "ἐμένομεν", "ἐμένετε", "ἔμενον"],
      "1st Aorist Active Indicative": ["ἔμεινα", "ἔμεινας", "ἔμεινε(ν)", "ἐμείναμεν", "ἐμείνατε", "ἔμειναν"],
      "Perfect Active Indicative": ["μεμένηκα", "μεμένηκας", "μεμένηκε(ν)", "μεμενήκαμεν", "μεμενήκατε", "μεμενήκασιν"],
    },
    subjunctive: {
  ...
  "ὁράω": {
    ...
    indicative: {
      "Present Active Indicative": ["ὁρῶ", "ὁρᾷς", "ὁρᾷ", "ὁρῶμεν", "ὁρᾶτε", "ὁρῶσιν"],
      ...
      "Perfect Active Indicative": ["ἑώρακα", "ἑώρακας", "ἑώρακε(ν)", "ἑωράκαμεν", "ἑωράκατε", "ἑωράκασιν"],
  ...
  "σῴζω": {
    ...
    indicative: {
      "Present Active Indicative": ["σῴζω", "σῴζεις", "σῴζει", "σῴζομεν", "σῴζετε", "σῴζουσιν"],
      "Present Middle/Passive Indicative": ["σῴζομαι", "σῴζῃ", "σῴζεται", "σῳζόμεθα", "σῴζεσθε", "σῴζονται"],
      "Future Active Indicative": ["σώσω", "σώσεις", "σώσει", "σώσομεν", "σώσετε", "σώσουσιν"],
      "Imperfect Active Indicative": ["ἔσῳζον", "ἔσῳζες", "ἔσῳζε(ν)", "ἐσῴζομεν", "ἐσῴζετε", "ἔσῳζον"],
      "1st Aorist Active Indicative": ["ἔσωσα", "ἔσωσας", "ἔσωσε(ν)", "ἐσώσαμεν", "ἐσώσατε", "ἔσωσαν"],
      "1st Aorist Passive Indicative": ["ἐσώθην", "ἐσώθης", "ἐσώθη", "ἐσώθημεν", "ἐσώθητε", "ἐσώθησαν"],
      "Perfect Active Indicative": ["σέσωκα", "σέσωκας", "σέσωκε(ν)", "σεσώκαμεν", "σεσώκατε", "σεσώκασιν"],
  ...
  "ἀκολουθέω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἀκολουθῶ", "ἀκολουθεῖς", "ἀκολουθεῖ", "ἀκολουθοῦμεν", "ἀκολουθεῖτε", "ἀκολουθοῦσιν"],
      "Future Active Indicative": ["ἀκολουθήσω", "ἀκολουθήσεις", "ἀκολουθήσει", "ἀκολουθήσομεν", "ἀκολουθήσετε", "ἀκολουθήσουσιν"],
      "Imperfect Active Indicative": ["ἠκολούθουν", "ἠκολούθεις", "ἠκολούθει", "ἠκολουθοῦμεν", "ἠκολουθεῖτε", "ἠκολούθουν"],
      "1st Aorist Active Indicative": ["ἠκολούθησα", "ἠκολούθησας", "ἠκολούθησε(ν)", "ἠκολουθήσαμεν", "ἠκολουθήσατε", "ἠκολούθησαν"],
      "Perfect Active Indicative": ["ἠκολούθηκα", "ἠκολούθηκας", "ἠκολούθηκε(ν)", "ἠκολουθήκαμεν", "ἠκολουθήκατε", "ἠκολουθήκασιν"],
    },
    subjunctive: {
  ...
  "διδάσκω": {
    meaning: "I teach",
    indicative: {
      "Present Active Indicative": ["διδάσκω", "διδάσκεις", "διδάσκει", "διδάσκομεν", "διδάσκετε", "διδάσκουσιν"],
      "Present Middle/Passive Indicative": ["διδάσκομαι", "διδάσκῃ", "διδάσκεται", "διδασκόμεθα", "διδάσκεσθε", "διδάσκονται"],
      "Future Active Indicative": ["διδάξω", "διδάξεις", "διδάξει", "διδάξομεν", "διδάξετε", "διδάξουσιν"],
      "Imperfect Active Indicative": ["ἐδίδασκον", "ἐδίδασκες", "ἐδίδασκε(ν)", "ἐδιδάσκομεν", "ἐδιδάσκετε", "ἐδίδασκον"],
      ...
      "Perfect Active Indicative": ["δεδίδαχα", "δεδίδαχας", "δεδίδαχε(ν)", "δεδιδάχαμεν", "δεδιδάχατε", "δεδιδάχασιν"],
    },
    subjunctive: {
  ...
  "ἐπερωτάω": {
    meaning: "I ask (for)",
    indicative: {
      "Present Active Indicative": ["ἐπερωτῶ", "ἐπερωτᾷς", "ἐπερωτᾷ", "ἐπερωτῶμεν", "ἐπερωτᾶτε", "ἐπερωτῶσιν"],
      "Future Active Indicative": ["ἐπερωτήσω", "ἐπερωτήσεις", "ἐπερωτήσει", "ἐπερωτήσομεν", "ἐπερωτήσετε", "ἐπερωτήσουσιν"],
      "Imperfect Active Indicative": ["ἐπηρώτων", "ἐπηρώτας", "ἐπηρώτα", "ἐπηρωτῶμεν", "ἐπηρωτᾶτε", "ἐπηρώτων"],
      "1st Aorist Active Indicative": ["ἐπηρώτησα", "ἐπηρώτησας", "ἐπηρώτησε(ν)", "ἐπηρωτήσαμεν", "ἐπηρωτήσατε", "ἐπηρώτησαν"],
    },
    subjunctive: {
  ...
  "ἐρωτάω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἐρωτῶ", "ἐρωτᾷς", "ἐρωτᾷ", "ἐρωτῶμεν", "ἐρωτᾶτε", "ἐρωτῶσιν"],
      "Future Active Indicative": ["ἐρωτήσω", "ἐρωτήσεις", "ἐρωτήσει", "ἐρωτήσομεν", "ἐρωτήσετε", "ἐρωτήσουσιν"],
      "Imperfect Active Indicative": ["ἠρώτων", "ἠρώτας", "ἠρώτα", "ἠρωτῶμεν", "ἠρωτᾶτε", "ἠρώτων"],
      "1st Aorist Active Indicative": ["ἠρώτησα", "ἠρώτησας", "ἠρώτησε(ν)", "ἠρωτήσαμεν", "ἠρωτήσατε", "ἠρώτησαν"],
    },
    subjunctive: {
  ...
  "θέλω": {
    ...
    indicative: {
      "Present Active Indicative": ["θέλω", "θέλεις", "θέλει", "θέλομεν", "θέλετε", "θέλουσιν"],
      "Future Active Indicative": ["θελήσω", "θελήσεις", "θελήσει", "θελήσομεν", "θελήσετε", "θελήσουσιν"],
      "Imperfect Active Indicative": ["ἤθελον", "ἤθελες", "ἤθελε(ν)", "ἠθέλομεν", "ἠθέλετε", "ἤθελον"],
      "1st Aorist Active Indicative": ["ἠθέλησα", "ἠθέλησας", "ἠθέλησε(ν)", "ἠθελήσαμεν", "ἠθελήσατε", "ἠθέλησαν"],
    },
    subjunctive: {
  ...
  "περιπατέω": {
    ...
    indicative: {
      "Present Active Indicative": ["περιπατῶ", "περιπατεῖς", "περιπατεῖ", "περιπατοῦμεν", "περιπατεῖτε", "περιπατοῦσιν"],
      "Future Active Indicative": ["περιπατήσω", "περιπατήσεις", "περιπατήσει", "περιπατήσομεν", "περιπατήσετε", "περιπατήσουσιν"],
      "Imperfect Active Indicative": ["περιεπάτουν", "περιεπάτεις", "περιεπάτει", "περιεπατοῦμεν", "περιεπατεῖτε", "περιεπάτουν"],
      "1st Aorist Active Indicative": ["περιεπάτησα", "περιεπάτησας", "περιεπάτησε(ν)", "περιεπατήσαμεν", "περιεπατήσατε", "περιεπάτησαν"],
    },
    subjunctive: {
  ...
  "λαμβάνω": {
    ...
    indicative: {
      "Present Active Indicative": ["λαμβάνω", "λαμβάνεις", "λαμβάνει", "λαμβάνομεν", "λαμβάνετε", "λαμβάνουσιν"],
      "Present Middle/Passive Indicative": ["λαμβάνομαι", "λαμβάνῃ", "λαμβάνεται", "λαμβανόμεθα", "λαμβάνεσθε", "λαμβάνονται"],
      "Future Active Indicative": ["λήμψομαι", "—", "—", "—", "—", "—"],
      ...
      "Perfect Active Indicative": ["εἴληφα", "εἴληφας", "εἴληφε(ν)", "εἰλήφαμεν", "εἰλήφατε", "εἰλήφασιν"],
  ...
  "γράφω": {
    meaning: "I write",
    indicative: {
      "Present Active Indicative": ["γράφω", "γράφεις", "γράφει", "γράφομεν", "γράφετε", "γράφουσιν"],
      "Present Middle/Passive Indicative": ["γράφομαι", "γράφῃ", "γράφεται", "γραφόμεθα", "γράφεσθε", "γράφονται"],
      "Future Active Indicative": ["γράψω", "γράψεις", "γράψει", "γράψομεν", "γράψετε", "γράψουσιν"],
      ...
      "Perfect Active Indicative": ["γέγραφα", "γέγραφας", "γέγραφε(ν)", "γεγράφαμεν", "γεγράφατε", "γεγράφασιν"],
  ...
  "δοξάζω": {
    ...
    indicative: {
      "Present Active Indicative": ["δοξάζω", "δοξάζεις", "δοξάζει", "δοξάζομεν", "δοξάζετε", "δοξάζουσιν"],
      "Present Middle/Passive Indicative": ["δοξάζομαι", "δοξάζῃ", "δοξάζεται", "δοξαζόμεθα", "δοξάζεσθε", "δοξάζονται"],
      "Future Active Indicative": ["δοξάσω", "δοξάσεις", "δοξάσει", "δοξάσομεν", "δοξάσετε", "δοξάσουσιν"],
  ...
  "κηρύσσω": {
    ...
    indicative: {
      "Present Active Indicative": ["κηρύσσω", "κηρύσσεις", "κηρύσσει", "κηρύσσομεν", "κηρύσσετε", "κηρύσσουσιν"],
      "Future Active Indicative": ["κηρύξω", "κηρύξεις", "κηρύξει", "κηρύξομεν", "κηρύξετε", "κηρύξουσιν"],
  ...
  "πίνω": {
    meaning: "I drink",
    indicative: {
      "Present Active Indicative": ["πίνω", "πίνεις", "πίνει", "πίνομεν", "πίνετε", "πίνουσιν"],
      ...
      "Perfect Active Indicative": ["πέπωκα", "πέπωκας", "πέπωκε(ν)", "πεπώκαμεν", "πεπώκατε", "πεπώκασιν"],
  ...
  "ἄγω": {
    ...
    indicative: {
      "Present Active Indicative": ["ἄγω", "ἄγεις", "ἄγει", "ἄγομεν", "ἄγετε", "ἄγουσιν"],
      "Present Middle/Passive Indicative": ["ἄγομαι", "ἄγῃ", "ἄγεται", "ἀγόμεθα", "ἄγεσθε", "ἄγονται"],
      "Future Active Indicative": ["ἄξω", "ἄξεις", "ἄξει", "ἄξομεν", "ἄξετε", "ἄξουσιν"],
      ...
      "Perfect Active Indicative": ["ἦχα", "ἦχας", "ἦχε(ν)", "ἤχαμεν", "ἤχατε", "ἤχασιν"],
  ...
  "χαίρω": {
    meaning: "I rejoice",
    indicative: {
      "Present Active Indicative": ["χαίρω", "χαίρεις", "χαίρει", "χαίρομεν", "χαίρετε", "χαίρουσιν"],
  ...
  "αἰτέω": {
    ...
    indicative: {
      "Present Active Indicative": ["αἰτῶ", "αἰτεῖς", "αἰτεῖ", "αἰτοῦμεν", "αἰτεῖτε", "αἰτοῦσιν"],
      "Present Middle/Passive Indicative": ["αἰτοῦμαι", "αἰτῇ", "αἰτεῖται", "αἰτούμεθα", "αἰτεῖσθε", "αἰτοῦνται"],
      "Future Active Indicative": ["αἰτήσω", "αἰτήσεις", "αἰτήσει", "αἰτήσομεν", "αἰτήσετε", "αἰτήσουσιν"],
      ...
      "Perfect Active Indicative": ["ᾔτηκα", "ᾔτηκας", "ᾔτηκε(ν)", "ᾐτήκαμεν", "ᾐτήκατε", "ᾐτήκασιν"],
    },
    subjunctive: {
  ...
  "μαρτυρέω": {
    ...
    indicative: {
      "Present Active Indicative": ["μαρτυρῶ", "μαρτυρεῖς", "μαρτυρεῖ", "μαρτυροῦμεν", "μαρτυρεῖτε", "μαρτυροῦσιν"],
      "Future Active Indicative": ["μαρτυρήσω", "μαρτυρήσεις", "μαρτυρήσει", "μαρτυρήσομεν", "μαρτυρήσετε", "μαρτυρήσουσιν"],
      ...
      "Perfect Active Indicative": ["μεμαρτύρηκα", "μεμαρτύρηκας", "μεμαρτύρηκε(ν)", "μεμαρτυρήκαμεν", "μεμαρτυρήκατε", "μεμαρτυρήκασιν"],
  ...
  "ἀναβαίνω": {
    meaning: "I go up",
    indicative: {
      "Present Active Indicative": ["ἀναβαίνω", "ἀναβαίνεις", "ἀναβαίνει", "ἀναβαίνομεν", "ἀναβαίνετε", "ἀναβαίνουσιν"],
  ...
  "ἐσθίω": {
    meaning: "I eat",
    indicative: {
      "Present Active Indicative": ["ἐσθίω", "ἐσθίεις", "ἐσθίει", "ἐσθίομεν", "ἐσθίετε", "ἐσθίουσιν"],
  ...
  "φέρω": {
    ...
    indicative: {
      "Present Active Indicative": ["φέρω", "φέρεις", "φέρει", "φέρομεν", "φέρετε", "φέρουσιν"],
      "Present Middle/Passive Indicative": ["φέρομαι", "φέρῃ", "φέρεται", "φερόμεθα", "φέρεσθε", "φέρονται"],
      "Future Active Indicative": ["οἴσω", "οἴσεις", "οἴσει", "οἴσομεν", "οἴσετε", "οἴσουσιν"],
  ...
  "εὐαγγελίζω": {
    ...
    indicative: {
      "Present Active Indicative": ["εὐαγγελίζω", "εὐαγγελίζεις", "εὐαγγελίζει", "εὐαγγελίζομεν", "εὐαγγελίζετε", "εὐαγγελίζουσιν"],
  ...
  "θεωρέω": {
    ...
    indicative: {
      "Present Active Indicative": ["θεωρῶ", "θεωρεῖς", "θεωρεῖ", "θεωροῦμεν", "θεωρεῖτε", "θεωροῦσιν"],
      "Future Active Indicative": ["θεωρήσω", "θεωρήσεις", "θεωρήσει", "θεωρήσομεν", "θεωρήσετε", "θεωρήσουσιν"],
  ...
  "ὑπάγω": {
    meaning: "I depart",
    indicative: {
      "Present Active Indicative": ["ὑπάγω", "ὑπάγεις", "ὑπάγει", "ὑπάγομεν", "ὑπάγετε", "ὑπάγουσιν"],
  ...
  "συνάγω": {
    ...
    indicative: {
      "Present Active Indicative": ["συνάγω", "συνάγεις", "συνάγει", "συνάγομεν", "συνάγετε", "συνάγουσιν"],
      "Present Middle/Passive Indicative": ["συνάγομαι", "συνάγῃ", "συνάγεται", "συναγόμεθα", "συνάγεσθε", "συνάγονται"],
      "Future Active Indicative": ["συνάξω", "συνάξεις", "συνάξει", "συνάξομεν", "συνάξετε", "συνάξουσιν"],
